...
async function formSend(e){
    ...
    var el = form;
    var nameValue = el.name.value;
    var groupValue = el.group.value;
    var idValue = el.ID.value;
    var birthdayValue = el.birthday.value;
    var emailValue = el.email.value;
    var fail=true;
...
variant.addEventListener('mouseover', e => {
    variant.style.backgroundColor = `#${parseInt(Math.random()*0xffffff).toString(16).padStart(6, '0')}`;
})
